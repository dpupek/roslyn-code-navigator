...
- [x] **Build/Test Runner Tools** (`BuildSolution`, `TestSolution`, `LegacyMsBuild`, `LegacyVsTest`)
...
- [x] Add discovery endpoints (`ListBuildRunners`) so agents can inspect available toolchains before invoking builds/tests.
